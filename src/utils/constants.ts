...
export const RINK_DIMENSIONS = {
  ...
  LARGE_WIDTH: 1440, // 720 → 1440 (+100% COLOSSAL!)
  LARGE_HEIGHT: 600, // 300 → 600 (+100% COLOSSAL!)
  ULTIMATE_WIDTH: 2000, // NEW LEGENDARY LEVEL!
  ULTIMATE_HEIGHT: 800, // ABSOLUTELY COLOSSAL!
};
